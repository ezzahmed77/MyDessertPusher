...
const val DESSERT_IMAGE_RESOURCE = "dessert_image_resource"

class MainActivity : AppCompatActivity(), LifecycleObserver {

    private var revenue = 0
    private var dessertsSold = 0
    private var dessertImageResourceId = R.drawable.cupcake
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Initializing dessert Timer
        dessertTimer = DessertTimer(this.lifecycle)

        // onClickListener for clicking on dessertImage
    ...
    override fun onRestoreInstanceState(savedInstanceState: Bundle) {
        ...
        Timber.i("OnRestoreInstanceStateCalled")
